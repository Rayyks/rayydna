  ...
  return (
    ...
    >
      <div className="container2">
        ...
        {/* END ABOUT BUTTON TOP RIGHT */}

        {/* MY NAME */}
        <div className="myName">
          <h1 className="NAME">RAYYAND KANANDA</h1>
          <h1 className="NAME2">RAYYAND KANANDA</h1>
          <h1 className="NAME3">RAYYAND KANANDA</h1>
          <h1 className="NAME4">RAYYAND KANANDA</h1>
        </div>
        {/* END MY NAME */}
      </div>
    </motion.div>
